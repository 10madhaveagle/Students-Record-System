...
public class StudentRegistrationFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Computer", "E&TC", "Civil", "Mechanical" }));
        ...
        jPanel1.setBounds(350, 90, 630, 540);

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/collegedatabasemanagementsystem/students.jpg"))); // NOI18N
...
///            JOptionPane.showMessageDialog(null, "User Name Is Empty");
        ...
        {
            StudentRegistration rst=new StudentRegistration();
            if(rst.isInserted(studid, studname,department,semester, mobile, email,  password))
            {
